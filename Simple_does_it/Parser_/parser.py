...
def divide_parser():
    ...
    # default: JPEGimages
    parser.add_argument('--img_dir_name', type = str, default = 'JPEGImages', help = 'name for image directory')
    # ratio for training set
    # default: 7
    parser.add_argument('--train_set_ratio', type = int, default = 7, help = 'ratio for training set, [0,10]')
    ...
    # default: test.txt
    parser.add_argument('--test_set_name', type = str, default = 'test.txt', help = 'name for testing set')
    ...
    print ('{:{}}: {}'.format('Training set ratio', SPACE, args.train_set_ratio))
...
def make_pair_parser():
    ...
    parser.add_argument('--train_pair_name', type = str, default = 'train_pairs.txt', help = 'name for training pair')
    ...
    print ('{:{}}: {}'.format('Annotation directory name', SPACE, args.ann_dir_name))
...
def grabcut_parser():
    ...
    parser.add_argument('--grabcut_dir_name', type = str, default = 'Grabcut_inst', help = 'name for grabcut directory')
    # name for img wiht grabcut directory 
    # default: img_grabcuts
    parser.add_argument('--img_grabcuts_dir', type = str, default = 'Grabcut_pairs', help = 'name for image with grabcuts directory')
    ...
    print ('{:{}}: {}'.format('Grabcut directory name', SPACE, args.grabcut_dir_name))
    print ('{:{}}: {}'.format('Label directory name', SPACE, args.label_dir_name))
...
def model_parser():
    ...
    parser.add_argument('--pair_dir_name', type = str, default = 'Pred_pairs', help = 'name for pairs directory')
    # directory for crf prediction masks 
    # default: ./dataset/CRF_masks
    parser.add_argument('--crf_dir_name', type = str, default = 'CRF_masks', help = 'name for crf prediction masks directory')
    ...
    print ('{:{}}: {}'.format('Training', SPACE, True if args.is_train else False))
    print ('{:{}}: {}'.format('Save step', SPACE, args.save_step))
    print ('{:{}}: {}'.format('Prediction masks directory name', SPACE, args.pred_dir_name))
    print ('{:{}}: {}'.format('Prediction pairs directory name', SPACE, args.pair_dir_name))
    print ('{:{}}: {}'.format('CRF prediction masks directory name', SPACE, args.crf_dir_name))
    print ('{:{}}: {}'.format('CRF prediction pairs directory name', SPACE, args.crf_pair_dir_name))
